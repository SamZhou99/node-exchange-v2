...
module.exports = {
    ...
    Cors(instance) {
        ...
        //             || origin.indexOf('gno-ex.com') != -1
        //             || origin.indexOf('coinbtc.us') != -1
        //             || origin.indexOf('coin-vn8867.com') != -1
        //             || origin.indexOf('coinwin88.com') != -1
        ...
        return (req, callback) => {
            ...
            const origin = req.headers.origin
            if (origin) {
                let a = config.cors.origin
                for (let i = 0; i < a.length; i++) {
                    if (origin.indexOf(a[i]) != -1) {
